    ...
    <main className="flex flex-col h-min-screen items-center p-4">
      <div className="w-full space-y-8 grid md:grid-cols-2 grid-cols-1">
        <div className="space-y-4 grid-cols-1 md:mt-10 mt-24">
          <div className="md:text-4xl mb-16 text-2xl text-left p-8 w-full h-28 text-slate-600">
            <TypeWriter
              content={"Hi! I'm Parfait AHOUANTO <br/>I'm Fullstack developer"}
            />
          </div>
          <div className="w-24 m-8 bg-blue-500 h-2 rounded-md"></div>
          <p className="text-justify text-slate-600 w-full md:w-full mx-auto text-md p-8">
        ...
        <div className="md:w-1/2 hidden md:inline-flex p-8 w-full  h-96 mx-auto mt-12 relative ">
          <div className="absolute  top-20 left-8 bg-slate-600 h-16 w-16 shadow-md rounded-md"></div>
          <Image
          ...
          />
          <div className="absolute animate-pulse bottom-4 right-8 shadow-md bg-slate-600 h-16 w-16 rounded-md"></div>
        </div>
      </div>
    </main>
  );
