    ...
    <>
      <div className="inline-block md:inline-flex justify-center space-x-2">
        <div className="p-2 w-full md:w-2/6 inline-flex space-x-2">
          <span className="w-6 mt-2 bg-blue-500 h-1.5 rounded-md"></span>
        ...
        <div className="w-full md:w-4/6 border-l-2 bg-gray-600 border-l-gray-300 p-4 space-y-3 flex flex-col">
